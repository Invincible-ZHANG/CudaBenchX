...
<figure>
  <img src="./picture/基于CPU+GPU的异构计算.png" alt="基于CPU+GPU的异构计算" width="600">
...
<figure>
  <img src="./picture/基于CPU+GPU的异构计算应用执行逻辑. 来源：Preofessional CUDA® C Programming.png" alt="基于CPU+GPU的异构计算应用执行逻辑" width="600">
  <figcaption><strong>图 2.</strong> 基于CPU+GPU的异构计算应用执行逻辑. 来源：Preofessional CUDA® C Programming</figcaption>
</figure>
...
<figure>
  <img src="./picture/CUDA编程模型支持的编程语言.png" alt="CUDA编程模型支持的编程语言" width="600">
  <figcaption><strong>图 3.CUDA编程模型支持的编程语言</figcaption>
</figure>
